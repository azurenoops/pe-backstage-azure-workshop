...
> Reminder: The kubconfig path is the path to the kubeconfig file generated by Terraform. It should be in the `terraform/control-plane` folder. It should be the entire path to the kubeconfig file.
