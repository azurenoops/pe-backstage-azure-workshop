...
output "kubelet_identity_client_id" {
  ...
  description = "Specifies the client id of the kubelet identity of the AKS cluster."
}
...
output "kubelet_identity_resource_id" {
  ...
  description = "Specifies the resource id of the kubelet identity of the AKS cluster."
}
...
output "portal_fqdn" {
  ...
  description = "The FQDN for the Kubernetes Cluster portal."
}
